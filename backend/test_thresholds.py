...
def test_thresholds():
    ...
    alerts = check_alerts(20.9, 0, 400, 25, 50, 'BUILDING')
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    
    # 2. Critical Oxygen
    print("\n[Test 2] Critical Oxygen (O2=15.0)")
    score = calculate_safety_score(15.0, 0, 400, 25, 50, 'BUILDING')
    alerts = check_alerts(15.0, 0, 400, 25, 50, 'BUILDING')
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    ...
    alerts = check_alerts(20.9, 40, 400, 25, 50, 'BUILDING')
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    ...
    alerts = check_alerts(20.9, 40, 400, 25, 50, 'VEHICLE')
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    ...
    alerts = check_alerts(20.9, 20, 1200, 25, 50, 'BUILDING')
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    ...
    alerts = check_alerts(16.0, 150, 3000, 25, 50, 'BUILDING')
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    ...
    alerts = check_alerts(20.9, 0, 1200, 25, 50, 'BUILDING', history=history)
    print(f"Safety Score: {score}")
    print(f"Alerts: {alerts}")
    ...
    # Current sample: 10 (Slightly above BUILDING threshold but significant relative to baseline)
    alerts = check_alerts(20.9, 10, 400, 25, 50, 'BUILDING', history=history)
    print(f"Alerts: {alerts}")
